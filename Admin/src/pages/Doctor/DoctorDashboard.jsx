...
const DoctorDashboard = () => {
  const { dToken, dashData, completeAppointment, cancelAppointment , getDashData } = useContext(DoctorContext);
    ...
    dashData && (
      <div className="m-5">
        <div className="flex flex-wrap gap-6">
          <div className="flex items-center gap-4 bg-white p-8 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all shadow-lg">
