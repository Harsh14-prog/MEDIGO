  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
     ...
     const { data } = await axios.post(
      ...
      {
        headers: {
          aToken,  // will be converted in smaller case automatically as we using atoken in backend while extract this in authAdmin
  ...
  return (
    <form onSubmit={onSubmitHandler} className="m-5 w-full">
      ...
      <div className="bg-white px-8 py-8 border border-gray-200 rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll">
        ...
        <button type="submit" className="bg-blue-500 px-8 py-2 mt-4 text-white rounded-full">Add doctor</button>
